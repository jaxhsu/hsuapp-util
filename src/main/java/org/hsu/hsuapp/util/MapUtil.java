...
public class MapUtil {
	 ...
	 * @return
	 */
	public static Map getFromMap(final Map map, final String[] keys) {
		Map rtn = new HashMap();
		for (String key : keys) {
	 ...
	 * @return
	 */
	public static Map margeMap(final Map map1, final Map map2) {
		// TODO not ready
		return null;
	}

	/**
	 * from org.apache.commons.collections.MapUtils 3.2.1
	 */
	 ...
	 * @return
	 */
	public static String getStringIsEmpty(Map map, Object key, String defaultValue) {
		String answer = getString(map, key);
